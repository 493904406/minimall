...
public class LitemallTopicExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGoodsCriterion(String condition, Object value, String property) {
            ...
            goodsCriteria.add(new Criterion(condition, value, "com.minimall.common.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGoodsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            goodsCriteria.add(new Criterion(condition, value1, value2, "com.minimall.common.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public interface IExampleWhen {
        void example(com.minimall.user.domain.entity.LitemallTopicExample example);
    }
}