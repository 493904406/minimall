...
public class LitemallGoodsProductExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addSpecificationsCriterion(String condition, Object value, String property) {
            ...
            specificationsCriteria.add(new Criterion(condition, value, "com.minimall.common.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addSpecificationsCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            specificationsCriteria.add(new Criterion(condition, value1, value2, "com.minimall.common.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public interface IExampleWhen {
        void example(com.minimall.user.domain.entity.LitemallGoodsProductExample example);
    }
}