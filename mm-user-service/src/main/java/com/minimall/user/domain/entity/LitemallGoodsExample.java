...
public class LitemallGoodsExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGalleryCriterion(String condition, Object value, String property) {
            ...
            galleryCriteria.add(new Criterion(condition, value, "com.minimall.common.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGalleryCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            galleryCriteria.add(new Criterion(condition, value1, value2, "com.minimall.common.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public interface IExampleWhen {
        void example(com.minimall.user.domain.entity.LitemallGoodsExample example);
    }
}