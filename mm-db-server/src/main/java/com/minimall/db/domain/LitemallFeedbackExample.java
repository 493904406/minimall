...
public class LitemallFeedbackExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addPicUrlsCriterion(String condition, Object value, String property) {
            ...
            picUrlsCriteria.add(new Criterion(condition, value, "com.minimall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addPicUrlsCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            picUrlsCriteria.add(new Criterion(condition, value1, value2, "com.minimall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
