...
import com.minimall.user.domain.entity.*;
import com.minimall.user.service.LitemallGoodsAttributeService;
import com.minimall.user.service.LitemallGoodsProductService;
import com.minimall.user.service.LitemallGoodsSpecificationService;
...
import static com.minimall.admin.util.AdminResponseCode.GOODS_NAME_EXIST;
...
public class AdminGoodsService {
    ...
    public Object list(String goodsSn, String name,
        ...
        List<LitemallGoods> goodsList = null;//goodsService.querySelective(goodsSn, name, page, limit, sort, order);
