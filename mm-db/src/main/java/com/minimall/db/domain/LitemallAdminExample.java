...
public class LitemallAdminExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addRoleIdsCriterion(String condition, Object value, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value, "com.minimall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addRoleIdsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value1, value2, "com.minimall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
